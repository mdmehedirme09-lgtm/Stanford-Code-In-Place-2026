...
def erase_objects(canvas, eraser):
    ...
    ovarlapping_objects=canvas.find_overlapping(left_x,top_y,right_x,bottom_y)

    for ovarlapping_object in ovarlapping_objects:
        if ovarlapping_object!=eraser:
            canvas.set_color(ovarlapping_object,"White")
